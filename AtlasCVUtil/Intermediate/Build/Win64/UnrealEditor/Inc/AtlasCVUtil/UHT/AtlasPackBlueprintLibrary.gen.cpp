...
DEFINE_FUNCTION(UAtlasPackBlueprintLibrary::execCombineTexturesToAtlas)
{
	...
	P_FINISH;
	P_NATIVE_BEGIN;
	*(TArray<UTexture2D*>*)Z_Param__Result=UAtlasPackBlueprintLibrary::CombineTexturesToAtlas(Z_Param_Out_Textures,Z_Param_OutDataAsset,Z_Param_bSavePNG,Z_Param_bSaveJSON,Z_Param_SaveDirectory,Z_Param_AtlasSize,TextureMipGenSettings(Z_Param_MipGenSetting));
	P_NATIVE_END;
}
...
struct Z_Construct_UClass_UAtlasPackBlueprintLibrary_Statics
{
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_UAtlasPackBlueprintLibrary_CombineTexturesToAtlas, "CombineTexturesToAtlas" }, // 1582646502
	};
...
struct Z_CompiledInDeferFile_FID_bak_Bak77_Plugins_AtlasCVUtil_Source_AtlasCVUtil_Public_AtlasPackBlueprintLibrary_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UAtlasPackBlueprintLibrary, UAtlasPackBlueprintLibrary::StaticClass, TEXT("UAtlasPackBlueprintLibrary"), &Z_Registration_Info_UClass_UAtlasPackBlueprintLibrary, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAtlasPackBlueprintLibrary), 2051050971U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_bak_Bak77_Plugins_AtlasCVUtil_Source_AtlasCVUtil_Public_AtlasPackBlueprintLibrary_h_1446986035(TEXT("/Script/AtlasCVUtil"),
